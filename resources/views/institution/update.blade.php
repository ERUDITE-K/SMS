...
<body><div class="register-photo">
    <div class="form-container">
        <form method="post" action="{{route('update',$institution->id)}}">
        {{csrf_field()}}
            <h2 class="text-center"><strong>UPDATE</strong> INSTITUTION.</h2>
            <div id="nav">
                <div class="form-group"><input class="form-control" type="text" name="name" placeholder="{{$institution->name}}" value="{{$institution->id}}" /></div>        

            ...
            <div class="container">
                ...
                <div class="list-group notes-group">
                    ...
                    <div class="card card-block">
                        <a href="{{route('new',$rank->id)}}">
                            <h4 class="card-title">
                                {{$rank->name}}
                            </h4>
                        </a>
                        
                        <a class="btn btn-sm btn-info pull-xs-left" href="{{route('upform',$rank->id)}}">
                            Edit
                        </a>
                        <form action="{{route('destroy',$rank->id)}}" class="pull-xs-right" method="POST">
                            {{csrf_field()}}

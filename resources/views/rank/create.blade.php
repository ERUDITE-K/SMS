...
<body><div class="register-photo">
    <div class="form-container">
        ...
        {{csrf_field()}}
            <h2 class="text-center"><strong>CREATE</strong> RANK.</h2>
            <div id="nav">
                <div class="form-group"><input class="form-control" type="text" name="name[]" placeholder="Rank"   /></div>        
                <div class="form-group"><input class="form-control" type="text" name="name[]" placeholder="Rank"   /></div>        
                <div class="form-group"><input class="form-control" type="text" name="name[]" placeholder="Rank"   /></div>        
                <div class="form-group"><input class="form-control" type="text" name="name[]" placeholder="Rank"  /></div>        
                <div class="form-group"><input class="form-control" type="text" name="name[]" placeholder="Rank"   /></div>        
                ...
                <div style="max-height: 95%"><button class="btn btn-primary btn-block" type="submit">Add +</button></div>
            </div>
